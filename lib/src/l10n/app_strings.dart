...
class AppStrings {
  ...
  String get totalRewardDkk => pick(ru: '\u041e\u0431\u0449\u0430\u044f \u043d\u0430\u0433\u0440\u0430\u0434\u0430 \u0432 DKK', en: 'Total reward in DKK', da: 'Samlet bel\u00f8nning i DKK');
  String get rewardInputHint => pick(ru: '\u041c\u043e\u0436\u043d\u043e \u0443\u043a\u0430\u0437\u0430\u0442\u044c \u0431\u0430\u043b\u043b\u044b \u0438\u043b\u0438 DKK: \u0432\u0442\u043e\u0440\u043e\u0435 \u043f\u043e\u043b\u0435 \u0432\u044b\u0447\u0438\u0441\u043b\u0438\u0442\u0441\u044f \u0430\u0432\u0442\u043e\u043c\u0430\u0442\u0438\u0447\u0435\u0441\u043a\u0438.', en: 'Enter points or DKK. The other value is calculated automatically.', da: 'Indtast point eller DKK. Den anden v\u00e6rdi beregnes automatisk.');
  ...
  String get reviewAndFinalize => pick(ru: '\u041f\u0440\u043e\u0432\u0435\u0440\u0438\u0442\u044c \u0438 \u0437\u0430\u0432\u0435\u0440\u0448\u0438\u0442\u044c', en: 'Review and finalize', da: 'Gennemse og afslut');
  String get taskOutcome => pick(ru: '\u0418\u0442\u043e\u0433 \u0437\u0430\u0434\u0430\u0447\u0438', en: 'Task outcome', da: 'Opgavens resultat');
  String get completedAndRewarded => pick(ru: '\u0417\u0430\u0432\u0435\u0440\u0448\u0438\u043b(\u0430), \u043d\u0430\u0433\u0440\u0430\u0434\u0438\u0442\u044c', en: 'Completed, reward', da: 'Fuldf\u00f8rt, bel\u00f8n');
  String get withdrewNoReward => pick(ru: '\u041d\u0435 \u0437\u0430\u0432\u0435\u0440\u0448\u0438\u043b(\u0430), \u0431\u0435\u0437 \u043d\u0430\u0433\u0440\u0430\u0434\u044b', en: 'Did not finish, no reward', da: 'Ikke fuldf\u00f8rt, ingen bel\u00f8nning');
  String get chooseOutcomeForEveryone => pick(ru: '\u0412\u044b\u0431\u0435\u0440\u0438\u0442\u0435 \u0438\u0442\u043e\u0433 \u0434\u043b\u044f \u043a\u0430\u0436\u0434\u043e\u0433\u043e \u0443\u0447\u0430\u0441\u0442\u043d\u0438\u043a\u0430.', en: 'Choose an outcome for every participant.', da: 'V\u00e6lg et resultat for hver deltager.');
  String rewardSplitPreview(int points, int people) => pick(ru: '\u041d\u0430\u0433\u0440\u0430\u0434\u0430: $points \u0431\u0430\u043b\u043b\u043e\u0432 \u043d\u0430 $people \u0443\u0447\u0430\u0441\u0442\u043d\u0438\u043a\u043e\u0432.', en: 'Reward: $points points for $people participants.', da: 'Bel\u00f8nning: $points point til $people deltagere.');
  String get confirmedBy => pick(ru: '\u041f\u043e\u0434\u0442\u0432\u0435\u0440\u0434\u0438\u043b', en: 'Confirmed by', da: 'Bekr\u00e6ftet af');
  String get approveParticipant => pick(ru: '\u041f\u043e\u0434\u0442\u0432\u0435\u0440\u0434\u0438\u0442\u044c \u0443\u0447\u0430\u0441\u0442\u043d\u0438\u043a\u0430', en: 'Approve participant', da: 'Godkend deltager');
  String get approveCompletedAndPay => pick(ru: '\u041f\u043e\u0434\u0442\u0432\u0435\u0440\u0434\u0438\u0442\u044c \u0437\u0430\u0432\u0435\u0440\u0448\u0438\u0432\u0448\u0438\u0445 \u0438 \u043e\u043f\u043b\u0430\u0442\u0438\u0442\u044c', en: 'Approve completed and pay', da: 'Godkend afsluttede og betal');
